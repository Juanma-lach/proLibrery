...
<form class="form-horizontal" role="form" action="#" id="stockForm" name="formulario">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            <input type="text" id="cantidad" class="form-control"  name="cantidad" size="15" placeholder="Introduce la cantidad de libros" />
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label"  for="precio">Precio:</label>
        <div class="col-sm-6">
            <input type="text" id="isbn" class="form-control"  name="precio" size="15" placeholder="Introduce el precio del libro" />
        </div>
    </div>
                ...
                .bootstrapValidator({
                    ...
                    fields: {
                        ...
                        libro: {
                            validators: {
                                notEmpty: {
                                    message: 'Debe introducir un libro'
                                }
                            }
                        },
                        precio: {
